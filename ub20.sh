...
USRSC=$(curl -sS https://raw.githubusercontent.com/tridebleng/permission/main/ip | grep $MYIP | awk '{print $2}')
    EXPSC=$(curl -sS https://raw.githubusercontent.com/tridebleng/permission/main/ip | grep $MYIP | awk '{print $3}')
